...
return (
  <div className='shadow-md w-full fixed top-0 left-0 '>
    ...
    <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-purple-700 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ':'top-[-490px]'}`}>
      {
        Links.map((link)=>(
